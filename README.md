...
<!-- Presentación -->
<h4>Soy <picture><img src="https://github.com/7oSkaaa/7oSkaaa/blob/main/Images/about_me.gif?raw=true" width="20px"></picture> Thomás Ramírez, Desarrollador Full Stack con más de 2 años construyendo productos digitales que convierten visitas en resultados de negocio reales.
Mi stack cubre el ciclo completo: <img src="https://media.giphy.com/media/eNAsjO55tPbgaor7ma/giphy.gif" alt="React gif" width="20" /> React, JavaScript ES6+, HTML5, CSS3, Tailwind, Sass, PHP y MySQL en el lado técnico, y <img src="https://media.giphy.com/media/3de1kqCxacXCh2s3NF/giphy.gif" alt="WordPress logo spinning" width="20"> WordPress, Elementor Pro, Webflow, Yoast SEO, Figma y Git para llevar cada proyecto del prototipo al deploy.
Trabajé de forma remota con <img src="https://media.tenor.com/1AeGqzlhs_cAAAAi/game-gaming.gif" alt="Puzzle gif" width="20"> empresas en EE.UU. y Argentina entregando resultados concretos: +60% de visibilidad SEO orgánica, +40% de velocidad de carga y funnels que generaron impacto directo en el negocio de cada cliente.
Integro IA en cada proyecto: Claude (Anthropic), Stitch y Antigravity forman parte de mi flujo de trabajo para entregar más rápido, con mayor precisión y sin sacrificar calidad técnica.
Me importa el código limpio <img src="https://media.tenor.com/DlICV9zIlbAAAAAi/penguin-penguin-clean.gif" alt="Clean gif" width="20">, el diseño con propósito <img src="https://media.tenor.com/gg2GoB_YbwoAAAAi/pride-month-pride.gif" width="10px"> y construir cosas que tengan impacto real <picture><img src="https://github.com/7oSkaaa/7oSkaaa/blob/main/Images/OS.gif?raw=true" width="20px"></picture>.</h4>
